...
generateParameterSamples <- function(numParams, numParticles, priorMin, priorMax) {
    .Call(`_intractmodelinf_generateParameterSamples`, numParams, numParticles, priorMin, priorMax)
}
